...
create table products (
  ...
  name text not null,
  purchase_price numeric not null, -- Represents the total cost of the initial purchase batch
  cost_per_unit numeric not null default 0, -- The calculated cost for a single unit
